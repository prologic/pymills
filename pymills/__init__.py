...
__entry_points__ = """
[console_scripts]
telnet.py = examples/net/telnet.py
pysqlplus = examples/pysqlplus
spider = examples/spider
bench.py = examples/event/bench.py
ircbot.py = examples/net/ircbot.py
tcpforward.py = examples/net/tcpforward.py
"""
