...
class Connection:
	"""Connection(uri, log=None,/ dryrun=False, 
			debug=False) -> new connection

	Create a new connection object to the database specified
	by the uri. If dryrun=True, don't actually execute any
	of the SQL queries given by C.do or C.execute
	NOTE: This is only useful if debug=True and log is set to
